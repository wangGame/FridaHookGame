...
,
     {
        ...
        onLeave(retval) {
//            console.log("   return =", retval.toInt32());
            console.log("   original returnxxxxxxxxxxxxx =", retval.toInt32());
            // 🔥 强制修改返回值为 0

            console.log("   patched return  xxxxxxxxxxxxxxxxxxxxxxxxx=", retval.toInt32());
        }
    },
     {
...
//        );
//
//            console.log(`🎲 RNG operator() => ${r}, this=${this.thisPtr}`);
//    console.log("🧵 Backtrace:\n" + bt);
//    }
//});
//
