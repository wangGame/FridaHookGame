CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CAAC,CAAM,EAAE,GAAW,EAAE,EAAE,CAAC,CAAC;wBAC1D,IAAI,EAAE,CAAC,CAAC,EAAE,IAAI,IAAI,MAAM,GAAG,EAAE,CAAW;wBACxC,IAAI,EAAE,QAAQ,CAAC,CAAC,EAAE,IAAI,CAAC;qBACxB,CAAC,CAAC,CAAC;oBAEJ,MAAM,CAAC,IAAI,CAAC;wBACV,IAAI,EAAE,QAAQ;wBACd,MAAM,EAAE,MAAM,CAAC,IAAI;wBACnB,QAAQ,EAAE,OAAO;wBACjB,SAAS,EAAE,EAAE;wBACb,KAAK,EAAE,OAAO;wBACd,aAAa;wBACb,MAAM,EAAE,CAAC,CAAC,IAAI,IAAI,EAAE;wBACpB,IAAI,EAAE,OAAO;wBAEb,QAAQ,EAAE,CAAC,CAAE,CAAS,CAAC,QAAQ;wBAC/B,UAAU,EAAE,QAAQ,CAAE,CAAS,CAAC,UAAU,CAAC;wBAC3C,MAAM,EAAE,EAAE;wBACV,UAAU,EAAE,EAAE,CAAC,MAAM;wBAErB,EAAE,EAAE,EAAE,CAAC,QAAQ,EAAE;wBACjB,GAAG,EAAE,QAAQ,CAAC,GAAG,CAAC,QAAQ,EAAE,EAAE,EAAE,CAAC;wBAEjC,SAAS,EAAE,mBAAmB,CAAC,CAAC,CAAC;qBAClC,CAAC,CAAC;iBACJ;aACF;SACF;QAAC,OAAO,CAAC,EAAE;YACV,OAAO,CAAC,GAAG,CAAC,6BAA6B,EAAE,OAAO,EAAE,CAAC,CAAC,CAAC;SACxD;KACF;IAED,OAAO,CAAC,GAAG,CAAC,iCAAiC,EAAE,MAAM,CAAC,MAAM,CAAC,CAAC;IAE9D,IAAI,CAAC;QACH,IAAI,EAAE,4BAA4B;QAClC,IAAI,EAAE,MAAM;KACb,CAAC,CAAC;AACL,CAAC,CAAC,CAAC"}
✄
...
Il2Cpp.perform(() => {
    ...
    function isNoisyClassName(name) {
        if (!FILTER_NOISY_TYPES)
            return false;
    ...
    function getFieldOffset(f) {
        // 不同版本 bridge 字段名不同，做 fallback
        const off = (typeof f.offset === "number" ? f.offset : undefined) ??
            (typeof f.fieldOffset === "number" ? f.fieldOffset : undefined) ??
            (typeof f.instanceOffset === "number" ? f.instanceOffset : undefined) ??
            0;
        return off | 0;
    }
    function getFieldIsStatic(f) {
        const v = (typeof f.isStatic === "boolean" ? f.isStatic : undefined) ??
    ...
    function getMethodParams(m) {
        ...
        try {
            if (typeof m.parameterCount === "number" && typeof m.parameter === "function") {
                const arr = [];
                for (let i = 0; i < m.parameterCount; i++)
                    arr.push(m.parameter(i));
                return arr;
            }
        }
        catch { }
    ...
    function methodSignatureText(m) {
    ...
    for (const asmName of targetAssemblies) {
        try {
            ...
            for (const c of image.classes) {
                ...
                if (FILTER_NOISY_TYPES && isNoisyClassName(clsName))
                    continue;
                ...
                for (const m of c.methods) {
                    ...
                    const newName = `${cleanClass}__${cleanMethod}`;
                    const ps = getMethodParams(m).map((p, idx) => ({
                        name: (p?.name ?? `arg${idx}`),
