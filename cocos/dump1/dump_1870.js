function processWithoutCycles(root,data,visited,mark){if(visited.has(root))return;visited.add(root);var importLinks=root.querySelectorAll("link[rel=import]");
