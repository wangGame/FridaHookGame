...
var e;
null === (e = this.armatureDisplay) || void 0 === e || e.playAnimation("in", 1);
};
...
this.armatureDisplay.playAnimation("init", -1);
};
t.prototype.loadCompleteSetSiblingIndex = function() {};
a([ s(dragonBones.ArmatureDisplay) ], t.prototype, "armatureDisplay", void 0);
return a([ classId("AdventureOverdueBtnEff"), c, classMethodWatch() ], t);
}(i.default);
o.default = u;
cc._RF.pop();
}, {
...
AdventureOverdueChapterContent: [ function(e, t, o) {
"use strict";
cc._RF.push(t, "29431CV5W5N9oOkNP7LyWOE", "AdventureOverdueChapterContent");
...
var c = e("../../../base/cache/CacheRender"), s = e("../../../base/components/Component"), u = e("../../chapterConfig/type/ChapterConfigType"), f = e("../../prefab/PrefabConfig"), d = e("../config/AdventureOverdueConfig"), p = e("../vo/ClassAdventureOverdueInfo"), h = e("./AdventureOverdueChapterItem"), m = e("./AdventureOverdueChapterLevelTxt"), _ = cc._decorator, y = _.ccclass, g = _.property, v = function(e) {
n(t, e);
function t() {
...
case 0:
e.trys.push([ 0, 3, , 4 ]);
this.chapterListCfg = this.state.chapterListCfg;
this.setCupPos();
this.setNodeSize();
...
var e;
return i(this, void 0, void 0, function() {
var t, o, r, n, a, i, s, u, d, p, m, _, y, g = this;
return l(this, function(l) {
switch (l.label) {
case 0:
t = this.chapterListCfg;
o = t.length;
r = (null === (e = t[0]) || void 0 === e ? void 0 : e.length) || 0;
n = 80;
this.scroll.content.height = o * n + 900;
(a = cc.view.getVisibleSize()).height > this.scroll.content.height && (this.scroll.content.height = a.height);
this.scroll.content.position = cc.v3(0, -this.scroll.node.height / 2, 0);
this.levelCount = 0;
...
prefabUrl: f.PrefabConfig.AdventureOverdueChapterItem.url,
count: this.levelCount,
typeOrClassName: h.default,
bundleName: f.PrefabConfig.AdventureOverdueChapterItem.bundleName
}) ];
...
for (u = o - 1; u >= 0; u--) {
d = o % 2;
for (p = 0; p < t[u].length; p++) if (-1 != (m = t[u][p])) {
_ = 0 != d ? cc.v3(-Math.floor(r / 2) * n + n * p, 250 + (o - u) * n) : cc.v3(-r / 2 * n + n / 2 + n * p, 250 + (o - u) * n);
if (y = i[s]) {
s++;
y.node.setPosition(_);
y.setState({
levelNum: s,
color: m,
showColor: s <= this.state.lastChapter
});
...
t.prototype.loadLevelText = function() {
return i(this, void 0, void 0, function() {
var e, t, o, r, n;
...
prefabUrl: f.PrefabConfig.AdventureOverdueChapterLevelTxt.url,
count: this.levelCount,
typeOrClassName: m.default,
bundleName: f.PrefabConfig.AdventureOverdueChapterLevelTxt.bundleName
}) ];

case 1:
e = a.sent();
for (t = 0; t < this.levelCount; t++) if (o = this.itemList[t]) {
if (!e || !e[t]) continue;
r = t + 1;
e[t].node.x = o.node.x;
e[t].node.y = o.node.y;
e[t].node.name = "关卡数字" + r;
void 0;
n = this.state.way[0] && this.state.way[0] !== u.StageShowType.fromBottom ? 0 : r <= this.state.lastChapter ? 0 : 255;
e[t].setState({
text: r.toString(),
opacity: n,
level: r
...
t.prototype.setItemListOrder = function() {
var e = storage.getItem("chapterPeriodsIndex", 1), t = this.ItemListColor;
if (this.state.way[0] == u.StageShowType.random) {
var o = this.stageItemOrderList;
if (o.stage == e && o.orderList.length > 0) {
for (var r = [], n = 0; n < o.orderList.length; n++) r.push(this.itemList[o.orderList[n]]);
this.itemList = r;
var a = [];
for (n = 0; n < o.orderList.length; n++) a.push(t[o.orderList[n]]);
t = a;
} else {
var i = [];
for (n = 0; n < this.itemList.length; n++) i.push(n);
i.sort(function() {
return Math.random() - .5;
});
for (r = [], n = 0; n < i.length; n++) r.push(this.itemList[i[n]]);
for (a = [], n = 0; n < i.length; n++) a.push(t[i[n]]);
t = a;
this.itemList = r;
}
} else if (this.state.way[0] == u.StageShowType.byColor) {
var l = this.state.order, c = [];
for (a = [], n = 0; n < l.length; n++) for (var s = 0; s < t.length; s++) if (t[s] == l[n]) {
c.push(s);
a.push(t[s]);
}
for (r = [], n = 0; n < c.length; n++) r.push(this.itemList[c[n]]);
t = a;
this.itemList = r;
}
for (n = 0; n < this.itemList.length; n++) this.itemList[n].setState({
levelNum: n + 1,
color: t[n],
showColor: n + 1 <= this.state.lastChapter
});
};
Object.defineProperty(t.prototype, "ItemListColor", {
get: function() {
for (var e = this.chapterListCfg, t = [], o = e.length - 1; o >= 0; o--) for (var r = 0; r < e[o].length; r++) -1 != e[o][r] && t.push(e[o][r]);
return t;
},
enumerable: !1,
configurable: !0
...
get: function() {
return storage.getItem("chapterContentItemOrder", {
stage: 1,
orderList: []
});
},
...
t.prototype.setCupPos = function() {
var e = this.state.chapterListCfg;
this.cupContainer.y = e.length * d.AdventureOverdueConfig.itemHeight + d.AdventureOverdueConfig.cupNodeOffsetY;
};
t.prototype.setNodeSize = function() {
var e = cc.winSize.height, t = cc.winSize.width;
this.bgNode.setContentSize(t, e);
this.maskNode.setContentSize(t, e);
this.maskBgNode.setContentSize(t, e);
this.scroll.node.setContentSize(t, e);
this.bgNode.y = this.maskBgNode.y = this.scroll.node.y = 0;
this.maskNode.y = e / 2;
};
t.prototype._playAni = function() {
var e = this;
if (this.maskNode) {
var t = cc.winSize.height, o = cc.winSize.width;
this.maskNode.setContentSize(o, t);
cc.tween(this.maskNode).delay(1).to(.83, {
height: 0
}, {
easing: cc.easing.cubicOut
}).call(function() {
e.node.active = !1;
p.classAdventureOverdueInfo.savePrevChaptData();
}).start();
}
};
a([ g(cc.ScrollView) ], t.prototype, "scroll", void 0);
a([ g(cc.Node) ], t.prototype, "itemContainer", void 0);
a([ g(cc.Node) ], t.prototype, "cupContainer", void 0);
a([ g(cc.Node) ], t.prototype, "bgNode", void 0);
a([ g(cc.Node) ], t.prototype, "maskNode", void 0);
a([ g(cc.Node) ], t.prototype, "maskBgNode", void 0);
return a([ y ], t);
}(s.default);
o.default = v;
cc._RF.pop();
...
"../../../base/components/Component": "Component",
"../../chapterConfig/type/ChapterConfigType": "ChapterConfigType",
"../../prefab/PrefabConfig": "PrefabConfig",
"../config/AdventureOverdueConfig": "AdventureOverdueConfig",
"../vo/ClassAdventureOverdueInfo": "ClassAdventureOverdueInfo",
"./AdventureOverdueChapterItem": "AdventureOverdueChapterItem",
"./AdventureOverdueChapterLevelTxt": "AdventureOverdueChapterLevelTxt"
} ],
AdventureOverdueChapterItem: [ function(e, t, o) {
"use strict";
cc._RF.push(t, "cb637TACIZGZ5ZEvVerjUMY", "AdventureOverdueChapterItem");
var r, n = this && this.__extends || (r = function(e, t) {
return (r = Object.setPrototypeOf || {
__proto__: []
} instanceof Array && function(e, t) {
...
var c = e("../../../base/components/Component"), s = e("../../../base/loader/ResLoader"), u = e("../../chapterConfig/configs/ChapterConfig_Config"), f = cc._decorator, d = f.ccclass, p = f.property, h = function(e) {
n(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.bg = null;
...
t.prototype.render = function() {
return i(this, void 0, void 0, function() {
var e, t, o, r, n, a = this;
return l(this, function(i) {
switch (i.label) {
case 0:
this.stopAllAction();
e = this.bg;
return [ 4, s.ResLoader.asyncLoadByBundle("chapter", u.ChapterResPathConfig_Config.commonBgPath, cc.SpriteFrame) ];

case 1:
e.spriteFrame = i.sent();
if (!this.state.showColor) return [ 3, 4 ];
t = this.colorInfo(this.state.color, {
type: "local",
url: "textures/chapterList/periods/block/" + this.state.color
}), o = t.type, r = t.url;
if ("local" !== o) return [ 3, 3 ];
n = this.colorImg;
return [ 4, s.ResLoader.asyncLoadByBundle("chapter", r, cc.SpriteFrame) ];
...
case 3:
s.ResLoader.asyncLoad(r, cc.Texture2D).then(function(e) {
a.colorImg.spriteFrame = new cc.SpriteFrame();
a.colorImg.spriteFrame.setTexture(e);
}).catch(function() {});
i.label = 4;
...
t.prototype.colorInfo = function(e, t) {
return t;
};
a([ p(cc.Sprite) ], t.prototype, "bg", void 0);
a([ p(cc.Sprite) ], t.prototype, "colorImg", void 0);
return a([ classId("AdventureOverdueChapterItem"), d, classMethodWatch() ], t);
}(c.default);
o.default = h;
cc._RF.pop();
}, {
...
"../../chapterConfig/configs/ChapterConfig_Config": "ChapterConfig_Config"
} ],
AdventureOverdueChapterLevelTxt: [ function(e, t, o) {
"use strict";
cc._RF.push(t, "21e3fzD4URAV5nI6fx7dNos", "AdventureOverdueChapterLevelTxt");
var r, n = this && this.__extends || (r = function(e, t) {
return (r = Object.setPrototypeOf || {
__proto__: []
} instanceof Array && function(e, t) {
...
var c = e("../../../base/components/Component"), s = cc._decorator.ccclass, u = function(e) {
n(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t._level = 0;
