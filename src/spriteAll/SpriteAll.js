CAAC,MAAM,CAAC,YAAY,EAAE,CAAC,CAAC,CAAC,MAAM,CAAC,MAAM,CAAC,CAAC;YACvD,CAAC,CAAC;YAEF,OAAO,CAAC,GAAG,CAAC,4CAA4C,CAAC,CAAC;SAE7D;QAAC,OAAO,CAAC,EAAE;YACR,OAAO,CAAC,GAAG,CAAC,uCAAuC,GAAG,CAAC,CAAC,CAAC;SAC5D;IACL,CAAC;IAED,SAAS,kBAAkB;QACvB,IAAI;YACA,MAAM,cAAc,GAAQ,QAAQ,CAChC,CAAC,wBAAwB,CAAC,EAC1B,4BAA4B,CAC/B,CAAC;YAEF,MAAM,SAAS,GAAQ,cAAc,CAAC,MAAM,CAAC,YAAY,EAAE,CAAC,CAAC,CAAC;YAE9D,SAAS,CAAC,cAAc,GAAG,UAAU,MAAW;gBAC5C,UAAU,CAAC,MAAM,EAAE,uCAAuC,CAAC,CAAC;gBAE5D,OAAO,IAAI,CAAC,MAAM,CAAC,YAAY,EAAE,CAAC,CAAC,CAAC,MAAM,CAAC,MAAM,CAAC,CAAC;YACvD,CAAC,CAAC;YAEF,OAAO,CAAC,GAAG,CAAC,kDAAkD,CAAC,CAAC;SAEnE;QAAC,OAAO,CAAC,EAAE;YACR,OAAO,CAAC,GAAG,CAAC,6CAA6C,GAAG,CAAC,CAAC,CAAC;SAClE;IACL,CAAC;IAED,WAAW,EAAE,CAAC;IACd,kBAAkB,EAAE,CAAC;IAErB,OAAO,CAAC,GAAG,CAAC,4BAA4B,CAAC,CAAC;AAC9C,CAAC,CAAC,CAAC"}
✄
// SpriteAll.ts
...
Il2Cpp.perform(() => {
    ...
    const Il2CppAny = Il2Cpp;
    function getClass(asmNames, className) {
    ...
    function tryGetClass(asmNames, className) {
        try {
    ...
    const Texture2D = getClass(["UnityEngine.CoreModule"], "UnityEngine.Texture2D");
    const RenderTexture = getClass(["UnityEngine.CoreModule"], "UnityEngine.RenderTexture");
    const Graphics = getClass(["UnityEngine.CoreModule"], "UnityEngine.Graphics");
    const Rect = getClass(["UnityEngine.CoreModule"], "UnityEngine.Rect");
    const ImageConversion = tryGetClass(["UnityEngine.ImageConversionModule", "UnityEngine.CoreModule"], "UnityEngine.ImageConversion");
    try {
    ...
    function getObjName(obj) {
        try {
            const s = obj.method("get_name", 0).invoke();
    ...
    function getInstanceKey(obj) {
        try {
            const id = obj.method("GetInstanceID", 0).invoke();
            return String(id);
        }
        catch (_) {
            try {
    ...
    function invokeNumber(obj, methodName) {
        const v = obj.method(methodName, 0).invoke();
        return Number(v);
    }
    function newRect(x, y, w, h) {
        const rectObj = Rect.new();
        try {
    ...
    function saveTextureRectToPng(sourceTex, x, y, w, h, savePath) {
        ...
        try {
            ...
            const outTex = newTexture2D(w, h);
            const readRect = newRect(x, y, w, h);
            ...
            const pngBytes = encodeToPng(outTex);
            File.method("WriteAllBytes", 2).invoke(Il2Cpp.string(savePath), pngBytes);
    ...
    function dumpSprite(sprite, from) {
        if (isNullObj(sprite))
            return;
        ...
        let h = 0;
        try {
            const rect = sprite.method("get_textureRect", 0).invoke();
    ...
    function hookUIImage() {
        try {
            const UIImage = getClass(["UnityEngine.UI"], "UnityEngine.UI.Image");
            const setSprite = UIImage.method("set_sprite", 1);
            setSprite.implementation = function (sprite) {
    ...
    function hookSpriteRenderer() {
        try {
            const SpriteRenderer = getClass(["UnityEngine.CoreModule"], "UnityEngine.SpriteRenderer");
            const setSprite = SpriteRenderer.method("set_sprite", 1);
            setSprite.implementation = function (sprite) {
