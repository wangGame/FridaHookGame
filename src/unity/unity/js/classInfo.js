📦
590 /js/unity/ts/ClassInfo.js.map
400 /js/unity/ts/ClassInfo.js
160220 /node_modules/frida-il2cpp-bridge/dist/index.js
↻ frida-il2cpp-bridge
✄
{"version":3,"file":"ClassInfo.js","sourceRoot":"E:/tool/FridaHookGame/","sources":["js/unity/ts/ClassInfo.ts"],"names":[],"mappings":"AAAA,OAAO,qBAAqB,CAAC;AAG7B,MAAM,CAAC,OAAO,CAAC,GAAG,EAAE;IAEhB,MAAM,KAAK,GAAG,MAAM,CAAC,MAAM;SACtB,QAAQ,CAAC,iBAAiB,CAAC;SAC3B,KAAK;SACL,KAAK,CAAC,MAAM,CAAC,CAAC,CAAG,SAAS;IAE/B,OAAO,CAAC,GAAG,CAAC,uBAAuB,EAAE,KAAK,CAAC,IAAI,EAAE,MAAM,CAAC,CAAC;IAEzD,KAAK,CAAC,MAAM,CAAC,OAAO,CAAC,CAAC,KAAU,EAAE,EAAE;QAChC,OAAO,CAAC,GAAG,CACP,QAAQ,KAAK,CAAC,IAAI,UAAU,KAAK,CAAC,IAAI,CAAC,IAAI,UAAU,KAAK,CAAC,QAAQ,EAAE,CACxE,CAAC;IACN,CAAC,CAAC,CAAC;AACP,CAAC,CAAC,CAAC"}
✄
...
Il2Cpp.perform(() => {
    ...
    klass.fields.forEach((field) => {
        console.log(`字段名: ${field.name} | 类型: ${field.type.name} | 静态: ${field.isStatic}`);
    });
});
✄
"use strict";
