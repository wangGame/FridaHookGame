...
o.E_ClassTopInfo_Show = a;
cc._RF.pop();
}, {
"../../../../../../scripts/falcon/ModuleEvent": void 0
} ],
E_ClassWin_Click: [ function(e, t, o) {
"use strict";
cc._RF.push(t, "5ef10pAcPJEno3Fngu3wxMR", "E_ClassWin_Click");
...
o.E_ClassWin_Click = a;
cc._RF.pop();
}, {
"../../../../../../scripts/falcon/ModuleEvent": void 0
} ],
E_ClassWin_Show: [ function(e, t, o) {
"use strict";
cc._RF.push(t, "699988Wdr9NUqiEo9GpscrQ", "E_ClassWin_Show");
var r, i = this && this.__extends || (r = function(e, t) {
return (r = Object.setPrototypeOf || {
__proto__: []
} instanceof Array && function(e, t) {
...
E_OverRevive_Fail: [ function(e, t, o) {
"use strict";
cc._RF.push(t, "536dfX2HvxMdqt0qLveeE/u", "E_OverRevive_Fail");
var r, i = this && this.__extends || (r = function(e, t) {
return (r = Object.setPrototypeOf || {
__proto__: []
} instanceof Array && function(e, t) {
...
o.E_OverRevive_Fail = a;
cc._RF.pop();
}, {
"../../../../../../scripts/falcon/ModuleEvent": void 0
} ],
E_OverRevive_GameEnd: [ function(e, t, o) {
"use strict";
cc._RF.push(t, "21cb9u7U5BJPYpzkAC+/64L", "E_OverRevive_GameEnd");
var r, i = this && this.__extends || (r = function(e, t) {
return (r = Object.setPrototypeOf || {
__proto__: []
} instanceof Array && function(e, t) {
...
o.E_OverRevive_GameEnd = a;
cc._RF.pop();
}, {
"../../../../../../scripts/falcon/ModuleEvent": void 0
} ],
E_OverRevive_Show: [ function(e, t, o) {
"use strict";
cc._RF.push(t, "143bcwCpc1CTq62YuoIX4iO", "E_OverRevive_Show");
var r, i = this && this.__extends || (r = function(e, t) {
return (r = Object.setPrototypeOf || {
__proto__: []
} instanceof Array && function(e, t) {
...
o.E_OverRevive_Show = a;
cc._RF.pop();
}, {
"../../../../../../scripts/falcon/ModuleEvent": void 0
} ],
EntropyIncreaseBeforeFillTrait: [ function(e, t, o) {
"use strict";
cc._RF.push(t, "3bb64EejdZM6r6w3Eb28qCF", "EntropyIncreaseBeforeFillTrait");
var r, i = this && this.__extends || (r = function(e, t) {
return (r = Object.setPrototypeOf || {
__proto__: []
} instanceof Array && function(e, t) {
...
o.EntropyIncreaseBeforeFillTrait = void 0;
var s = e("../../../../../../scripts/base/trait/Trait"), n = e("../../../../../../scripts/modules/algorithm/type/AlgorithmType"), l = e("../../../../../../scripts/modules/algorithmStrategy/type/AlgorithmStrategyType"), c = e("../../../../../../scripts/modules/binary/vo/BinarySupport"), u = e("../../../../../../scripts/modules/board/vo/BoardInfo"), d = e("../../../../../../scripts/modules/traits/typePredicate/TraitTypePredicate"), p = e("../../../../../../scripts/base/storage/Storage"), m = e("../../../../../../scripts/modules/algorithmStrategy/decorate/DecoratorAlgorithm"), f = e("../../../../../../scripts/modules/algorithmStrategy/vo/AlgorithmStrategyInfo"), y = function(e) {
i(t, e);
function t() {
return null !== e && e.apply(this, arguments) || this;
}
t.prototype.onActive = function(e) {
if (d.tp.isClassGame_ProxyOnGameStart(e)) {
var t = Date.now(), o = p.storage.getItem("entropyIncreaseBeforeFill", {
state: 0,
startTime: 0
}), r = (o.state, o.startTime);
r = t;
p.storage.setItem("entropyIncreaseBeforeFill", {
state: 0,
startTime: r
});
this.resetTrait();
} else d.tp.isClassAlgorithmStrategy_Deal_ProxyTriggerSpecialTrait(e) && this.triggerLogic();
};
t.prototype.roundHandle = function() {
return !1;
};
t.prototype.getLimitTime = function() {
return 120;
};
t.prototype.getLimitWeight = function() {
return 310;
};
t.prototype.getCondition = function(e) {
return e > this.getLimitTime();
};
t.prototype.triggerLogic = function() {
if (!this.roundHandle()) {
var e = Date.now(), t = p.storage.getItem("entropyIncreaseBeforeFill", {
state: 0,
startTime: 0
}), o = t.state, r = t.startTime, i = (e - r) / 1e3, a = c.binarySupport.getWeightValue(u.boardInfo.faceBlocks);
if (2 === o || this.getCondition(i)) {
o = 2;
p.storage.setItem("entropyIncreaseBeforeFill", {
state: o,
startTime: r
...
var s = 0 === o ? n.OFFER_TYPE.SHANG_ZENG_3 : n.OFFER_TYPE.TIAN_KONG_XIAO_CHU;
f.algorithmStrategyInfo.setAlgorithmList([ s ]);
f.algorithmStrategyInfo.setAlgorithmSourceLevel1(l.ClassAlgorithmSourceType.AlgoTrait);
f.algorithmStrategyInfo.setAlgorithmSourceLevel2(this.traitName);
}
}
};
t.prototype.resetTrait = function() {};
a([ m.Algorithm() ], t.prototype, "onActive", null);
return a([ classId("EntropyIncreaseBeforeFillTrait"), classMethodWatch() ], t);
}(s.Trait);
o.EntropyIncreaseBeforeFillTrait = y;
cc._RF.pop();
}, {
...
EveryGamePreRoundForceToAlgoTrait: [ function(e, t, o) {
"use strict";
cc._RF.push(t, "1ddd9aDz3FNBrsKN5FbGSvz", "EveryGamePreRoundForceToAlgoTrait");
var r, i = this && this.__extends || (r = function(e, t) {
return (r = Object.setPrototypeOf || {
__proto__: []
} instanceof Array && function(e, t) {
...
o.EveryGamePreRoundForceToAlgoTrait = void 0;
var l = e("../../../../../../scripts/base/trait/Trait"), c = e("../../../../../../scripts/modules/algorithm/type/AlgorithmType"), u = e("../../../../../../scripts/modules/algorithmStrategy/type/AlgorithmStrategyType"), d = e("../../../../../../scripts/modules/algorithmStrategy/vo/AlgorithmStrategyInfo"), p = e("../../../../../../scripts/modules/traitConfig/vo/TraitConfigSafePropsInfo"), m = e("../../../../../../scripts/modules/traits/typePredicate/TraitTypePredicate"), f = e("../../game/vo/ClassGameInfo"), y = function(e) {
i(t, e);
function t() {
return null !== e && e.apply(this, arguments) || this;
}
Object.defineProperty(t.prototype, "startRound", {
get: function() {
return p.traitConfigSafePropsInfo.getSafePropValueByKey("EveryGamePreRoundForceToAlgoTrait", "StartRound", this.props, 0);
},
enumerable: !1,
configurable: !0
});
Object.defineProperty(t.prototype, "endRound", {
get: function() {
return p.traitConfigSafePropsInfo.getSafePropValueByKey("EveryGamePreRoundForceToAlgoTrait", "EndRound", this.props, 3);
},
enumerable: !1,
configurable: !0
});
Object.defineProperty(t.prototype, "algo", {
get: function() {
return p.traitConfigSafePropsInfo.getSafePropValueByKey("EveryGamePreRoundForceToAlgoTrait", "Algo", this.props, 1);
},
enumerable: !1,
configurable: !0
});
Object.defineProperty(t.prototype, "replaceAlgoId", {
get: function() {
return p.traitConfigSafePropsInfo.getSafePropValueByKey("EveryGamePreRoundForceToAlgoTrait", "replaceAlgoId", this.props, null);
},
enumerable: !1,
configurable: !0
});
