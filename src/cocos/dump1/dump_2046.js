function() {
function e() {
this._versionSupportedCache = null;
this._moduleCheckedThisSession = !1;
this._moduleEnabledThisSession = !1;
this._isBusinessInitialized = !1;
}
...
null === this._versionSupportedCache && (this._versionSupportedCache = a.HAccount.isVersionSupported());
return this._versionSupportedCache;
};
e.prototype.checkModuleStatus = function(e) {
if (!this._moduleCheckedThisSession) if (this.isVersionSupported()) {
var t = e();
this._moduleEnabledThisSession = t;
this._moduleCheckedThisSession = !0;
} else {
this._moduleEnabledThisSession = !1;
this._moduleCheckedThisSession = !0;
}
};
Object.defineProperty(e.prototype, "isModuleChecked", {
get: function() {
return this._moduleCheckedThisSession;
},
enumerable: !1,
configurable: !0
});
Object.defineProperty(e.prototype, "isModuleEnabled", {
get: function() {
return this._moduleEnabledThisSession;
},
enumerable: !1,
configurable: !0
});
Object.defineProperty(e.prototype, "isBusinessInitialized", {
get: function() {
return this._isBusinessInitialized;
},
enumerable: !1,
configurable: !0
});
e.prototype.initBusinessLogic = function() {
if (this._isBusinessInitialized) ; else if (this._moduleEnabledThisSession) {
this._isBusinessInitialized = !0;
l.accountInfo.init();
_.homePageAccountUI.init();
...
case 1:
t.trys.push([ 1, 3, , 4 ]);
return [ 4, a.HAccount.nativeGetLoginStatus() ];

case 2:
if (!(e = t.sent()) || "number" != typeof e.code) {
l.accountInfo.setLoggedIn(!1);
return [ 2 ];
}
l.accountInfo.setLoggedIn(e.code === a.NativeResponseCode.Success);
return [ 3, 4 ];
...
e.prototype.onGameEndDataCleared = function() {
this._isBusinessInitialized && l.accountInfo.refreshGameData();
};
e.prototype.onPeriodReset = function() {
if (this._isBusinessInitialized) {
var e = y.storage.getItem("chapterPeriodsIndex", 1);
l.accountInfo.updateStage(e);
}
};
e.prototype.onChapterPass = function() {
if (this._isBusinessInitialized) {
var e = y.storage.getItem("chapterNum", 0);
if (e <= l.accountInfo.stageProgress) ; else {
var t = l.accountInfo.totalPassCount + 1;
l.accountInfo.updateChapterPassData(e, t);
}
}
};
e.prototype.onSetupShow = function(e) {
this._moduleCheckedThisSession && this._moduleEnabledThisSession && (null == e ? void 0 : e.keys) && (e.keys.includes("account") || e.keys.push("account"));
};
e.prototype.onSetupClick = function() {
this._moduleEnabledThisSession;
};
e.prototype.sendLoginRequest = function(e) {
return r(this, void 0, Promise, function() {
var t, o, r, i, c;
return n(this, function(n) {
switch (n.label) {
case 0:
s.AccountLoading.show(0);
n.label = 1;

case 1:
n.trys.push([ 1, 3, 4, 5 ]);
t = this.collectLoginData();
return [ 4, a.HAccount.nativeLogin(t) ];

case 2:
o = n.sent();
if (a.HAccount.isLoginSuccess(o.code)) if (o.data) if (this.hasDataConflict(o.data)) {
r = this.getLocalDisplayData();
i = this.convertToDisplayData(o.data);
e.onDataConflict(r, i, o.data);
} else {
l.accountInfo.save(o.data);
e.onLoginSuccess();
} else {
l.accountInfo.setLoggedIn(!0);
e.onLoginSuccess();
} else e.onLoginFailed(a.HAccount.getLoginErrorMessage(o.code), o.code);
return [ 3, 5 ];

case 3:
c = n.sent();
e.onLoginFailed(String(c), a.NativeLoginCode.Failed);
return [ 3, 5 ];

case 4:
s.AccountLoading.hide();
return [ 7 ];
...
e.prototype.performLogin = function(e) {
var t = this;
this.sendLoginRequest({
onLoginSuccess: function() {
var t;
null === (t = null == e ? void 0 : e.onLoginSuccess) || void 0 === t || t.call(e);
},
onLoginCancelled: function() {
var t;
null === (t = null == e ? void 0 : e.onLoginCancelled) || void 0 === t || t.call(e);
},
onLoginFailed: function(t, o) {
var r;
null === (r = null == e ? void 0 : e.onLoginFailed) || void 0 === r || r.call(e, t, o);
},
onDataConflict: function(o, r, n) {
(null == e ? void 0 : e.onDataConflict) ? e.onDataConflict(o, r, n) : t.showSelectInfo(o, r, n, function() {
var t;
null === (t = null == e ? void 0 : e.onLoginSuccess) || void 0 === t || t.call(e);
});
}
...
e.prototype.sendLogoutRequest = function(e) {
return r(this, void 0, Promise, function() {
var t;
...
case 1:
o.trys.push([ 1, 3, 4, 5 ]);
return [ 4, a.HAccount.nativeLogout() ];

case 2:
if (o.sent().code === a.NativeResponseCode.Success) {
l.accountInfo.clear();
t = !0;
}
return [ 3, 5 ];
...
e.prototype.sendDeleteRequest = function(e, t) {
return r(this, void 0, Promise, function() {
var o;
...
case 1:
r.trys.push([ 1, 3, , 4 ]);
return [ 4, a.HAccount.nativeDeleteAccount() ];

case 2:
if (r.sent().code !== a.NativeResponseCode.Success) {
l.accountInfo.setLoggedIn(!1);
s.AccountLoading.hide();
this.showSyncFailedAlert(t);
e && e(!1);
return [ 2 ];
}
l.accountInfo.clear();
...
e.prototype.showSyncFailedAlert = function(e) {
p.default.showSyncFailedAlert(void 0, e);
};
e.prototype.showSelectInfo = function(e, t, o, s) {
return r(this, void 0, Promise, function() {
var _, y, g = this;
...
case 1:
v.trys.push([ 1, 3, , 4 ]);
return [ 4, u.UI.show(f.AccountPrefabConfig.SelectInfo, d.alertLayer) ];

case 2:
if (!(_ = v.sent()) || !cc.isValid(_)) {
l.accountInfo.save(o);
h.EventManager.dispatchModuleEvent(new m.E_Game_RefreshView({
classChangeScore: !0
}));
s();
return [ 2 ];
}
if (!(y = _.getComponent(c.default))) {
l.accountInfo.save(o);
h.EventManager.dispatchModuleEvent(new m.E_Game_RefreshView({
classChangeScore: !0
}));
...
y.show(e, t, function(e) {
return r(g, void 0, void 0, function() {
var t, r = this;
return n(this, function(n) {
switch (n.label) {
case 0:
if (e !== i.DataSelectType.Current) return [ 3, 2 ];
t = {
avatarIndex: l.accountInfo.avatarIndex,
nameId: l.accountInfo.nameId,
nameIndex: l.accountInfo.nameIndex,
classicScore: l.accountInfo.classicScore,
stage: l.accountInfo.stage,
stageProgress: l.accountInfo.stageProgress,
totalPassCount: l.accountInfo.totalPassCount,
is_new: !1
};
l.accountInfo.save(t);
return [ 4, this.syncLocalDataToServer() ];

case 1:
if (n.sent()) {
p.default.showAlert(a.NativeLoginCode.Success, s);
return [ 2 ];
}
l.accountInfo.setLoggedIn(!1);
this.showSyncFailedAlert(function() {
r.sendLoginRequest({
onLoginSuccess: s,
onLoginCancelled: function() {
return s();
...
onDataConflict: function(e, t, o) {
r.showSelectInfo(e, t, o, s);
}
});
});
return [ 2 ];
...
e.prototype.syncGameDataToServer = function() {
if (l.accountInfo.isLoggedIn) {
var e = {
game_info: {
classHighRecordScore: l.accountInfo.classicScore,
chapterPeriodsIndex: l.accountInfo.stage,
chapterNum: l.accountInfo.stageProgress,
chapterTotalPassCount: l.accountInfo.totalPassCount
}
};
a.HAccount.nativeSyncData(e).then(function() {}).catch(function() {});
}
};
e.prototype.syncLocalDataToServer = function() {
return r(this, void 0, Promise, function() {
var e;
return n(this, function(t) {
switch (t.label) {
...
e = {
user_info: {
img: l.accountInfo.avatarIndex,
name: l.accountInfo.nameId,
index: l.accountInfo.nameIndex
},
game_info: {
classHighRecordScore: l.accountInfo.classicScore,
chapterPeriodsIndex: l.accountInfo.stage,
...
return [ 4, a.HAccount.nativeSyncData(e) ];

case 2:
return t.sent().code === a.NativeResponseCode.Success ? [ 2, !0 ] : [ 2, !1 ];
...
e.prototype.hasDataConflict = function(e) {
var t, o, r, n, a;
if (!0 === e.is_new) return !1;
var i = l.accountInfo.nameId, c = l.accountInfo.nameIndex, s = l.accountInfo.avatarIndex, u = l.accountInfo.classicScore, f = l.accountInfo.totalPassCount, d = null !== (t = e.nameId) && void 0 !== t ? t : 0, p = null !== (o = e.nameIndex) && void 0 !== o ? o : -1, h = null !== (r = e.avatarIndex) && void 0 !== r ? r : 0, m = null !== (n = e.classicScore) && void 0 !== n ? n : 0, _ = null !== (a = e.totalPassCount) && void 0 !== a ? a : 0;
return i !== d || c !== p || s !== h || u !== m || f !== _;
};
e.prototype.collectLoginData = function() {
return {
user_info: {
img: l.accountInfo.avatarIndex,
name: l.accountInfo.nameId || 0,
index: l.accountInfo.nameIndex
},
game_info: {
classHighRecordScore: l.accountInfo.classicScore,
...
e.prototype.getLocalDisplayData = function() {
return {
nameId: l.accountInfo.nameId,
nameIndex: l.accountInfo.nameIndex,
avatarIndex: l.accountInfo.avatarIndex,
...
e.prototype.convertToDisplayData = function(e) {
var t, o, r, n, a, i, l;
return {
nameId: null !== (t = e.nameId) && void 0 !== t ? t : 0,
nameIndex: null !== (o = e.nameIndex) && void 0 !== o ? o : -1,
avatarIndex: null !== (r = e.avatarIndex) && void 0 !== r ? r : 0,
classicScore: null !== (n = e.classicScore) && void 0 !== n ? n : 0,
stage: null !== (a = e.stage) && void 0 !== a ? a : 1,
stageProgress: null !== (i = e.stageProgress) && void 0 !== i ? i : 0,
totalPassCount: null !== (l = e.totalPassCount) && void 0 !== l ? l : 0
};
};
Object.defineProperty(e.prototype, "isLoggedIn", {
get: function() {
return l.accountInfo.isLoggedIn;
},
enumerable: !1,
configurable: !0
});
...
o.AccountService = g;
o.accountService = g.instance;
cc._RF.pop();
}, {
"../../../base/storage/Storage": "Storage",
"../../../base/ui/UI": "UI",
"../../../falcon/EventManager": "EventManager",
"../../game/events/E_Game_RefreshView": "E_Game_RefreshView",
"../../http/HAccount": "HAccount",
"../../layer/vo/LayerInfo": "LayerInfo",
"../base/AccountConfig": "AccountConfig",
"../components/HomePageAccountUI": "HomePageAccountUI",
"../components/LoginResultAlert": "LoginResultAlert",
"../components/SelectInfo": "SelectInfo",
"../type/AccountType": "AccountType",
"../vo/AccountInfo": "AccountInfo",
"./AccountLoadingImpl": "AccountLoadingImpl"
} ],
AccountType: [ function(e, t, o) {
"use strict";
cc._RF.push(t, "9a064MhV3FJTZXhu2wzPVYN", "AccountType");
Object.defineProperty(o, "__esModule", {
value: !0
});
o.DataSelectType = o.AccountStatus = void 0;
(function(e) {
e[e.NotLoggedIn = 0] = "NotLoggedIn";
e[e.LoggedIn = 1] = "LoggedIn";
})(o.AccountStatus || (o.AccountStatus = {}));
(function(e) {
e[e.Current = 0] = "Current";
e[e.History = 1] = "History";
})(o.DataSelectType || (o.DataSelectType = {}));
cc._RF.pop();
}, {} ],
Account_Module: [ function(e, t, o) {
"use strict";
cc._RF.push(t, "674f01v+FRP4JWTCMJVbgQT", "Account_Module");
...
o.Account_Module = void 0;
var a = e("../../falcon/Module"), i = e("./proxys/Account_Proxy"), l = e("./base/AccountConfig"), c = function(e) {
n(t, e);
function t() {
