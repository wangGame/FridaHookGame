function(){var isMraidAttached=false;var log=function(message){try{if(typeof window.webkit.messageHandlers.safedkDebug.postMessage==="function"){window.webkit.messageHandlers.safedkDebug.postMessage(message)}}catch(error){}};var printError=function(error){try{if(typeof window.webkit.messageHandlers.safedkDebug.postMessage==="function"){window.webkit.messageHandlers.safedkDebug.postMessage("ERROR: "+fileName+" "+error.message+"\n"+error.stack)}}catch(error){}};function injectIntoIframe(win){const code=`
      (function(){
