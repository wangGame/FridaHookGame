CAAC;gBACf,CAAC,CAAC;aAEL;YAAC,OAAO,CAAC,EAAE;gBAER,OAAO,CAAC,GAAG,CACP,gBAAgB,EAChB,GAAG,EACH,CAAC,CACJ,CAAC;aACL;SACJ;IACL,CAAC;IAED,4DAA4D;IAC5D,MAAM;IACN,4DAA4D;IAE5D,MAAM,aAAa,GAAG;QAElB,qBAAqB;QAErB,gCAAgC;QAChC,kCAAkC;QAClC,kCAAkC;QAClC,uCAAuC;QACvC,2CAA2C;QAC3C,wCAAwC;QACxC,6CAA6C;QAC7C,+CAA+C;QAC/C,4CAA4C;QAC5C,2CAA2C;QAE3C,qCAAqC;QACrC,6BAA6B;QAE7B,+BAA+B;KAClC,CAAC;IAEF,KAAK,MAAM,OAAO,IAAI,aAAa,EAAE;QACjC,SAAS,CAAC,OAAO,CAAC,CAAC;KACtB;IAED,OAAO,CAAC,GAAG,CACP,4BAA4B,CAC/B,CAAC;AACN,CAAC,CAAC,CAAC"}
✄
...
Il2Cpp.perform(() => {
    ...
    function fmtValue(v) {
        try {
            ...
            try {
                if (v.class && v.handle) {
                    const clsName = shortClassName(v.class);
    ...
    // =========================================================
    function unityInvoke(obj, methodName) {
        try {
            return obj
                .method(methodName)
                .invoke();
    ...
    function unityName(obj) {
        try {
            const n = unityInvoke(obj, "get_name");
            if (n)
                return String(n);
        }
        catch (e) { }
    ...
    function unityGameObject(obj) {
        try {
            return unityInvoke(obj, "get_gameObject");
        }
        catch (e) {
            return null;
        }
    }
    function unityTransform(obj) {
        try {
            return unityInvoke(obj, "get_transform");
        }
        catch (e) {
            return null;
        }
    }
    function unityParent(transform) {
        try {
            return unityInvoke(transform, "get_parent");
        }
        catch (e) {
            return null;
        }
    ...
    function getTransformPath(transform) {
        try {
            let path = unityName(transform);
            let parent = unityParent(transform);
            while (parent) {
                path =
                    unityName(parent) +
                        "/" +
    ...
    function dumpUnityObject(obj) {
        try {
            ...
            try {
                if (obj.class &&
                    obj.class.name.indexOf("Transform") >= 0) {
                    console.log("🎯 Transform.name =", unityName(obj));
                    //                     console.log(
                    //                         "🎯 Transform.path =",
            ...
            // =================================================
            try {
                const go = unityGameObject(obj);
                if (go) {
                    console.log("🎯 GameObject.name =", unityName(go));
                    const tr = unityTransform(obj);
                    if (tr) {
                        console.log("🎯 GameObject.path =", getTransformPath(tr));
                    }
                    return;
                }
            }
            ...
            try {
                ...
                if (target) {
                    console.log("🎯 Tween.target =", fmtValue(target));
                    const go = unityGameObject(target);
                    if (go) {
                        console.log("🎯 Tween.target.name =", unityName(go));
                        const tr = unityTransform(target);
                        if (tr) {
                            console.log("🎯 Tween.target.path =", getTransformPath(tr));
                        }
                    }
                }
            }
            ...
            console.log("❌ dumpUnityObject failed");
        }
    }
    // =========================================================
    // invoke original
    ...
    function invokeOriginal(method, self, args) {
        ...
        try {
            ...
            console.log("❌ invoke original failed:", e);
        }
    }
    // =========================================================
    // 方法过滤
    ...
    function shouldHook(className, methodName) {
        ...
        if (className.indexOf("DG.Tweening.ShortcutExtensions") >= 0) {
            return methodName.startsWith("DO");
        }
        // =====================================================
    ...
    console.log("✅ DOTween Full Trace Ready");
});
✄
"use strict";
