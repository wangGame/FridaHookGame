GAAG,CAAC,WAAW,CAAC,WAAW,CAAC;iBAC5B,GAAG,CAAC,CAAC,CAAC,EAAE,CAAC,MAAM,GAAG,CAAC,CAAC,QAAQ,EAAE,CAAC;iBAC/B,IAAI,CAAC,IAAI,CAAC,CAAC;SACf;QAAC,OAAO,CAAC,EAAE;YACV,OAAO,wBAAwB,CAAC;SACjC;IACH,CAAC;IAED,IAAI,MAAM,GAAG,CAAC,CAAC;IAEf,KAAK,MAAM,GAAG,IAAI,MAAM,CAAC,MAAM,CAAC,UAAU,EAAE;QAC1C,MAAM,GAAG,GAAG,GAAG,CAAC,KAAK,CAAC;QAEtB,KAAK,MAAM,KAAK,IAAI,GAAG,CAAC,OAAO,EAAE;YAC/B,IAAI,CAAC,oBAAoB,CAAC,KAAK,CAAC;gBAAE,SAAS;YAE3C,KAAK,MAAM,CAAC,IAAI,KAAK,CAAC,OAAO,EAAE;gBAC7B,IAAI,CAAC,CAAC,cAAc,CAAC,MAAM,EAAE;oBAAE,SAAS;gBACxC,IAAI,CAAC,gBAAgB,CAAC,CAAC,CAAC,IAAI,CAAC;oBAAE,SAAS;gBACxC,IAAI,MAAM,IAAI,SAAS;oBAAE,MAAM;gBAE/B,MAAM,QAAQ,GAAG,CAAC,CAAC,cAAc,CAAC;gBAElC,CAAC,CAAC,cAAc,GAAG,UAAU,GAAG,IAAW;oBACzC,MAAM,EAAE,GAAG,EAAE,GAAG,CAAC;oBACjB,MAAM,CAAC,GAAG,GAAG,EAAE,CAAC;oBAChB,MAAM,CAAC,GAAG,UAAU,CAAC,GAAG,CAAC,CAAC,CAAC,IAAI,CAAC,CAAC;oBACjC,UAAU,CAAC,GAAG,CAAC,CAAC,EAAE,CAAC,GAAG,CAAC,CAAC,CAAC;oBAEzB,OAAO,CAAC,GAAG,CAAC,GAAG,MAAM,CAAC,CAAC,CAAC,IAAI,EAAE,WAAW,SAAS,CAAC,CAAC,CAAC,EAAE,CAAC,CAAC;oBAEzD,IAAI,eAAe,EAAE;wBACnB,IAAI;4BACF,kDAAkD;4BAClD,aAAa;4BACb,MAAM,EAAE,GAAG,eAAe,CAAC,IAAI,CAAC,OAAO,CAAC,CAAC;4BACzC,OAAO,CAAC,GAAG,CAAC,EAAE,CAAC,CAAC;yBACjB;wBAAC,OAAO,CAAC,EAAE,GAAE;qBACf;oBAED,IAAI,GAAQ,CAAC;oBACb,IAAI;wBACF,GAAG,GAAG,QAAQ,CAAC,KAAK,CAAC,IAAI,EAAE,IAAI,CAAC,CAAC;qBAClC;4BAAS;wBACR,MAAM,EAAE,GAAG,CAAC,UAAU,CAAC,GAAG,CAAC,CAAC,CAAC,IAAI,CAAC,CAAC,GAAG,CAAC,CAAC;wBACxC,UAAU,CAAC,GAAG,CAAC,CAAC,EAAE,EAAE,CAAC,CAAC;wBACtB,OAAO,CAAC,GAAG,CAAC,GAAG,MAAM,CAAC,EAAE,CAAC,IAAI,EAAE,WAAW,SAAS,CAAC,CAAC,CAAC,EAAE,CAAC,CAAC;qBAC3D;oBACD,OAAO,GAAG,CAAC;gBACb,CAAC,CAAC;gBAEF,MAAM,EAAE,CAAC;aACV;YAED,IAAI,MAAM,IAAI,SAAS;gBAAE,MAAM;SAChC;QAED,IAAI,MAAM,IAAI,SAAS;YAAE,MAAM;KAChC;IAED,OAAO,CAAC,GAAG,CAAC,cAAc,MAAM,qBAAqB,CAAC,CAAC;IACvD,OAAO,CAAC,GAAG,CAAC,6CAA6C,CAAC,CAAC;AAC7D,CAAC,CAAC,CAAC"}
✄
// @ts-nocheck
...
Il2Cpp.perform(() => {
    ...
    function shouldHookMethod(name) {
        const s = String(name);
        return methodNameAllow.some(k => s.includes(k));
    }
    function looksLikeTargetClass(klass) {
    ...
    function fmtMethod(m) {
        ...
        if (va.isNull())
            return `${k.namespace}.${k.name}::${m.name} (no impl)`;
    ...
    for (const asm of Il2Cpp.domain.assemblies) {
        ...
        for (const klass of img.classes) {
            if (!looksLikeTargetClass(klass))
                continue;
            for (const m of klass.methods) {
                if (m.virtualAddress.isNull())
                    continue;
                if (!shouldHookMethod(m.name))
                    continue;
                if (hooked >= MAX_HOOKS)
                    break;
