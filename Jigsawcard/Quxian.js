...
// Jigsawcard/Quxian.ts
Il2Cpp.perform(() => {
  const AnimationCurve = Il2Cpp.domain.assembly("UnityEngine.CoreModule").image.class("UnityEngine.AnimationCurve");
  ...
  Evaluate.implementation = function(...args) {
    ...
    console.log("\u{1F525} curve time:", time, "result:", result);
    return result;
  };
});
