📦
627 /Jigsawcard/test.js.map
383 /Jigsawcard/test.js
158176 /node_modules/frida-il2cpp-bridge/dist/index.js
↻ frida-il2cpp-bridge
✄
{"version":3,"file":"test.js","sourceRoot":"D:/Hook/HookLearn/","sources":["Jigsawcard/test.ts"],"names":[],"mappings":"AAAA,OAAO,qBAAqB,CAAC;AAC7B,MAAM,CAAC,OAAO,CAAC,GAAG,EAAE;IAChB,MAAM,CAAC,MAAM,CAAC,UAAU,CAAC,OAAO,CAAC,GAAG,CAAC,EAAE;QACnC,GAAG,CAAC,KAAK,CAAC,OAAO,CAAC,OAAO,CAAC,KAAK,CAAC,EAAE;YAE9B,OAAO,CAAC,GAAG,CAAC,QAAQ,EAAE,KAAK,CAAC,IAAI,CAAC,CAAC;YAElC,KAAK,CAAC,MAAM,CAAC,OAAO,CAAC,KAAK,CAAC,EAAE;gBACzB,OAAO,CAAC,GAAG,CACP,WAAW,EACX,KAAK,CAAC,IAAI,EACV,SAAS,EAAE,KAAK,CAAC,IAAI,CAAC,IAAI,EAC1B,WAAW,EAAE,KAAK,CAAC,MAAM,CAC5B,CAAC;YACN,CAAC,CAAC,CAAC;QAEP,CAAC,CAAC,CAAC;IACP,CAAC,CAAC,CAAC;AACP,CAAC,CAAC,CAAC"}
✄
    ...
    Il2Cpp.domain.assemblies.forEach(asm => {
        asm.image.classes.forEach(clazz => {
            ...
            clazz.fields.forEach(field => {
                console.log("   Field:", field.name, "| type:", field.type.name, "| offset:", field.offset);
            });
        });
    });
});
